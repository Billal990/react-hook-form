        ...
        outlined: {
          base: {
            input: {
              ...
              floated: {
                borderWidth: "border focus:border-1", //customized
            ...
            label: {
              ...
              before: {
                ...
                floated: {
                  bt: "before:border-t peer-focus:before:border-t-1", //customized
                  bl: "before:border-l peer-focus:before:border-l-1", //customized
                },
              ...
              after: {
                ...
                floated: {
                  bt: "after:border-t peer-focus:after:border-t-1", //customized from 2 to 1
                  br: "after:border-r peer-focus:after:border-r-1", //customized from 2 to 1
                },
